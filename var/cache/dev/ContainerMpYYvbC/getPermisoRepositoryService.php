 ...
 */
class getPermisoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PermisoRepository' shared autowired service.
     *
     * @return \App\Repository\PermisoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PermisoRepository.php';

        return $container->privates['App\\Repository\\PermisoRepository'] = new \App\Repository\PermisoRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
