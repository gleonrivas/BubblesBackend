...
class getAccessTokenRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccessTokenRepository.php';

        return $container->privates['App\\Repository\\AccessTokenRepository'] = new \App\Repository\AccessTokenRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
