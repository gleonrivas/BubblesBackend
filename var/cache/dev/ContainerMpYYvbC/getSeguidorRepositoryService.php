 ...
 */
class getSeguidorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SeguidorRepository' shared autowired service.
     *
     * @return \App\Repository\SeguidorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SeguidorRepository.php';

        return $container->privates['App\\Repository\\SeguidorRepository'] = new \App\Repository\SeguidorRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
