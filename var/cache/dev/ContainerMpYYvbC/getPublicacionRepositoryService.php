 ...
 */
class getPublicacionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PublicacionRepository' shared autowired service.
     *
     * @return \App\Repository\PublicacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PublicacionRepository.php';

        return $container->privates['App\\Repository\\PublicacionRepository'] = new \App\Repository\PublicacionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
